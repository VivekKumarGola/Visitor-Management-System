...
public class MainPageOne extends JFrame implements ActionListener {
	JMenuBar vms;
	JMenu ref,sfm,sft,ma,st,vis,dep;
	JMenuItem ad,as,adc,us,ms,mi,mf,mu,md;
	JMenuItem sfms,sfmi,sfmf,sfmu,sfmd,sfts,sfti,sftf,sftu,sftd;
	JMenuItem ss,si,sf,su,sd;
	JMenuItem vi,vo,vf,vu;
	JMenuItem ds,di,df,du,dd;
	...
	public MainPageOne() {
		...
		dep=new JMenu("Department");
		ma=new JMenu("Manager");
		st=new JMenu("Staff");
		vis=new JMenu("Visitor");
		
		sfms=new JMenuItem("Show All");
		sfmi=new JMenuItem("Insert");
		sfmf=new JMenuItem("Find");
		sfmu=new JMenuItem("Update");
		sfmd=new JMenuItem("Delete");
		sfm.add(sfms); sfm.add(sfmi);	sfm.add(sfmf);	sfm.add(sfmu);	sfm.add(sfmd);
		sfms.addActionListener(this);
		...
		ds=new JMenuItem("Show All");
		di=new JMenuItem("Insert");
		df=new JMenuItem("Find");
		du=new JMenuItem("Update");
		dd=new JMenuItem("Delete");
		dep.add(ds); dep.add(di);	dep.add(df);	dep.add(du);	dep.add(dd);
		ds.addActionListener(this);
		di.addActionListener(this);		df.addActionListener(this);
		du.addActionListener(this);		dd.addActionListener(this);
		...
		vo=new JMenuItem("Exit");
		vf=new JMenuItem("Find");
		vu=new JMenuItem("Update");
		vis.add(vi); vis.add(vo); vis.add(vf); vis.add(vu);
		vi.addActionListener(this); 	vo.addActionListener(this);	
		vf.addActionListener(this);		vu.addActionListener(this);
		...
		vms.add(ref); vms.add(sfm);  vms.add(sft);  vms.add(dep);	vms.add(ma); vms.add(st); vms.add(vis);
		setJMenuBar(vms);
