...
public class ShiftMasterDelete extends JFrame implements ActionListener{
	JLabel l1,s,m,t,w,th,fr,sat;
	JTextField t1;
	JCheckBox c1,c2,c3,c4,c5,c6,c7;
	JButton bt1,bt2,bt3;
	public ShiftMasterDelete() {
		setLayout(null);	
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==bt1) {
			...
			obj.makeConnection();
			String str=obj.deleteData("shift_master","SHIFTMASTER_ID" , a);
		...
		if(ae.getSource()==bt3) {
			String a=t1.getText();
				try {
						...
						String sql="select * from Shift_master where SHIFTMASTER_ID=?";
